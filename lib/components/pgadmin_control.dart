...
class _PgadmincontrolState extends State<Pgadmincontrol>
  ...
  static const String _pgadminScript = r'C:\gajahweb\pgadmin\pgAdmin4.py';
  ...
  Future<void> _writeConfigLocal(String port) async {
    ...
    final configContent = '''# Auto-generated by GajahWeb – do not edit manually.
DATA_DIR = r'$dataDir'
LOG_FILE = r'$logFile'
  ...
  Future<void> _triggerPgadmin(bool value) async {
    ...
    try {
      if (value) {
        ...
        sendTerminal('Menghentikan pgAdmin 4 [port $port]\nBerhasil Dilakukan!');
      }
    } catch (error) {
